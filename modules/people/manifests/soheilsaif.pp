class people::soheilsaif {
  ...
  git::config::global {
    ...
    'color.ui':   value => 'true';
    'user.name':  value => 'soheilsaif';
    'user.email': value => 's.saifipour@gmail.com';
  }
   ...
   osx::recovery_message { 'If this Mac is found, please call 0744 8062070': }
